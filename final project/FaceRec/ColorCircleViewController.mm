...
- (void)perform:(NSString *)command {
    ...
    } else if ([cmd isEqualToString: @"SING"])
    {
        ...
        NSLog(@"TIME");
        [self texttospeech:command];
    }else if([cmd isEqualToString:@"BALL"]){
        NSLog(@"BALL");
        [self texttospeech:command];
    }else if([cmd isEqualToString:@"SUPPORT"]){
...
-(void)texttospeech:(NSString *)command{
    ...
    if ([cmd isEqualToString:@"HELLO"]) {
       messageBody  = [NSString stringWithFormat:@"hello"];
    }
    ...
    {
        messageBody = [NSString stringWithFormat:@"Good bye. Have a good day"];
    }
    if ([cmd isEqualToString:@"YOU REMEMBER ME"])
    {
        messageBody = [NSString stringWithFormat:@"Ofcourse oshani"];
    }
    if ([cmd isEqualToString:@"BALL"])
    {
        messageBody = [NSString stringWithFormat:@"ball"];
    }
